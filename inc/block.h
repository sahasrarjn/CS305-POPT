...
class PACKET {
  public:
    ...
    PACKET() {
        // deprecated now
        // initialise test to -1 in packet to distinguish from other sources
        // 0 means either not updated in trace yet or the default in instruction structs
        // 1 means updated once in trace
        // 2 means updated twice in trace
        // test = -1
        instruction = 0;
        is_data = 1;
	fill_l1i = 0;
